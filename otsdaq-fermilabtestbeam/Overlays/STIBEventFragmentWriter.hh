#ifndef otsdaq_fermilabtestbeam_Overlays_STIBEventFragmentWriter_hh
#define otsdaq_fermilabtestbeam_Overlays_STIBEventFragmentWriter_hh
...
#include "otsdaq-fermilabtestbeam/Overlays/STIBEventFragment.hh"
...
otsftbf::STIBEventFragmentWriter::STIBEventFragmentWriter(artdaq::Fragment& f)
...
inline uint32_t* otsftbf::STIBEventFragmentWriter::dataBegin()
{
...
inline uint32_t* otsftbf::STIBEventFragmentWriter::dataEnd()
{
	return dataBegin() + stib_data_words();
}

inline void otsftbf::STIBEventFragmentWriter::resize(size_t nBytes)
{
...
inline size_t otsftbf::STIBEventFragmentWriter::calc_event_size_words_(size_t nBytes)
{
	return bytes_to_words_(nBytes) + hdr_size_words();
}

inline size_t otsftbf::STIBEventFragmentWriter::bytes_to_words_(size_t nBytes)
{
	auto mod(nBytes % bytes_per_word_());
	return (mod == 0) ? nBytes / bytes_per_word_() : nBytes / bytes_per_word_() + 1;
}

#endif /* otsdaq_fermilabtestbeam_Overlays_STIBEventFragmentWriter_hh */

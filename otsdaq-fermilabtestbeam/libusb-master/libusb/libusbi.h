...
static inline void usbi_err(struct libusb_context* ctx, const char* format, ...)
    LOG_BODY(ctx, LIBUSB_LOG_LEVEL_ERROR) static inline void usbi_warn(
        struct libusb_context* ctx, const char* format, ...)
        LOG_BODY(ctx, LIBUSB_LOG_LEVEL_WARNING) static inline void usbi_info(
            struct libusb_context* ctx, const char* format, ...)
            LOG_BODY(ctx, LIBUSB_LOG_LEVEL_INFO) static inline void usbi_dbg(
                const char* format, ...) LOG_BODY(NULL, LIBUSB_LOG_LEVEL_DEBUG)
...
/* Internal abstraction for poll (needs struct usbi_transfer on Windows) */
    ...
    defined(OS_NETBSD) || defined(OS_HAIKU) || defined(OS_SUNOS)
#include <unistd.h>
...
struct usbi_os_backend
{
	 ...
	 * Return 0 on success, or a LIBUSB_ERROR code on failure.
	 */
	int (*set_option)(struct libusb_context* ctx,
	 ...
	 * - another LIBUSB_ERROR code on other failure
	 */
	int (*release_interface)(struct libusb_device_handle* dev_handle,

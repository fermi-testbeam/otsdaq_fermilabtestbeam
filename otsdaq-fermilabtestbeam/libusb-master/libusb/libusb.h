 ...
 *  - LIBUSB_LOG_LEVEL_DEBUG (4)   : debug and informational messages are printed to
 * stderr
 */
...
typedef enum {
	 ...
	 * It is the user's responsibility to call libusb_close on any handle associated with
	 * a disconnected device. It is safe to call libusb_get_device_descriptor on a device
	 * that has left */

 ...
 * <li> Add the 2 letter <a
 * href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">ISO 639-1</a> code for your
 * locale at the end of \c usbi_locale_supported[]<br> Eg. for Chinese, you would add
 * "zh" so that: \code... usbi_locale_supported[] = { "en", "nl", "fr" };\endcode
 *    becomes:
 *    \code... usbi_locale_supported[] = { "en", "nl", "fr", "zh" };\endcode </li>
 * <li> Copy the <tt>{ / * English (en) * / ... }</tt> section and add it at the end of \c
 * usbi_localized_errors<br> Eg. for Chinese, the last section of \c usbi_localized_errors
 ...
 *     }
 * };\endcode </li>
 * <li> Translate each of the English messages from the section you copied into your
 * language </li> <li> Save the file (in UTF-8 format) and send it to \c
 * libusb-devel\@lists.sourceforge.net </li>
 * </ol>
 */

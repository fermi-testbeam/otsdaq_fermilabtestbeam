...
otsftbf::TriggerCounter::TriggerCounter(fhicl::ParameterSet const& ps)
    : art::EDAnalyzer(ps)
{
...
void otsftbf::TriggerCounter::AddTrigger(uint64_t trigNum, fragment_typeid fragId)
{
...
void otsftbf::TriggerCounter::analyze(art::Event const& e)
{
	TLOG_INFO("TriggerCounter")
...
void otsftbf::TriggerCounter::beginRun(art::Run const& e)
{
...
DEFINE_ART_MODULE(otsftbf::TriggerCounter)
